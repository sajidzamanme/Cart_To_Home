...
const SideBarTile = ({
  ...
  return (
    <button
      ...
      className={`flex flex-row items-center justify-between w-[99%] self-center p-2 my-0.5 rounded-lg text-left shadow-[0px_0px_3px_1px_rgb(199,224,255)] hover:bg-[#DBE2EF] ${
